...
INSERT INTO `belong_to` VALUES 
  ('ACMU01','Two Pointers'),
  ('ACMU02','Bitmanipulation'),
  ('ACMU02','Sorting'),
  ('ACMU02','Two Pointers'),
  ('ACMU03','Hashing'),
  ('ACMU03','Stacks'),
  ...
  ('ACMU04','Sorting'),
  ('CDR02','Strings'),
  ('CDR03','Bitmanipulation'),
  ('CDR03','Strings'),
  ('CODA01',' Binary search'),
  ('CODA02','Arrays'),
  ('CODA02','Back tracking'),
  ('CODA02','Hashing'),
  ('CODA02','Stacks'),
  ('CODA03','Back tracking'),
  ('CODA03','Strings'),
  ('CODE01','Linked Lists'),
  ('CODE03','Back tracking'),
  ('CODE03','Dynamic programming'),
  ('CODW02','Recursion'),
  ('DZER01','Recursion'),
  ('DZER02','Depth First search'),
  ('DZER02','Greedy'),
  ('DZER03','Binary Trees'),
  ('DZER03','Greedy'),
  ('DZER03','Recursion'),
...
INSERT INTO `contests` VALUES 
  (1,'Codeathon 3.o',1500,'CSEA'),
  (2,'ACM Unlock',1200,'ECEA'),
  (3,'Coderbyte',2000,'IIIH'),
  (4,'Code wars 4.0',1000,'Harbour Space Univer sity'),
  (5,'Divide By zero',10000,'Harvard University'),
  (6,'Kick Start',5000,'CodeNation'),
  (7,'Hash Code',2500,'CSEA');
...
INSERT INTO `practice_problems` VALUES 
  ('ACMU01','easy'),
  ('ACMU02','easy'),
  ('ACMU03','medium'),
  ('ACMU04','medium'),
...
INSERT INTO `profile` VALUES ('akhil',4.2,9,3,10,7),
  ('asam_123',4.8,3,10,15,10),
  ('cyberpunk',4.4,7,20,50,4),
  ('happy_1',5.0,2,228,33,21),
  ('hema_123',4.6,5,300,14,8),
  ('icecuber',4.0,11,27,16,5),
  ('leo',4.7,4,90,16,12),
  ('m3g4n',5.0,1,200,15,13),
  ('noob',4.3,8,5,10,7),
  ('snake_eyes',4.1,10,50,79,7),
  ('sruth_56',4.5,6,100,12,2);
...
INSERT INTO `results` VALUES 
  (2024001,1,600,'2024-03-23 12:45:03'),
...
INSERT INTO `solves` VALUES ('leo','ACMU01'),
  ('akhil','ACMU02'),
  ('hema_123','CODE01'),
  ('noob','CODE02'),
  ('icecuber','DZER01'),
...
INSERT INTO `topic` VALUES 
  (' Binary search',3,'easy'),
  ('Arrays',3,'easy'),
  ('Back tracking',3,'hard'),
  ('Binary Trees',2,'hard'),
  ('Bitmanipulation',2,'medium'),
  ('Depth First search',2,'medium'),
...
INSERT INTO `user` VALUES 
  ...
  ('asam_123','asam',NULL,'samba','asamsamba@gmail.com','test1','Haidan'),
  ('cyberpunk','ashok',NULL,'valasa','ashokvalasa@gmail.com','G_czechout','Wah'),
  ('happy_1','bharath','kumar','reddy','bharathreddy@gmail.c om','123456789','Machida'),
  ('hema_123','hema','kumari','landa','hemalanda@gmail.com','12345678','Frankfurt'),
  ('icecuber','kalyan','siddartha','induri','kalyaninduri@gmail.com','asdfghjkl','Agartala'),
  ('leo','sujit','das',NULL,'sujitdas@gmail.com','password','Agartala'),
  ('m3g4n','meghana','kumari','pasikanti','meghanapasikanti@gmail.com','12345','HYD'),
  ('noob','rama',NULL,'rao','ramarao@gmail.com','asdf','Guwahati'),
  ('snake_eyes','manoj','kumar','reddy','manojreddy@gmail.com','1234567890','Vessy'),
